...
void CommandDispatcher::registerHandlers() {
    ...
    m_verbHandlers["clip"]      = [](const ParsedArgs& args) { return ClipHandler::handleCommand(args); };
    m_verbHandlers["midi"]      = [](const ParsedArgs& args) { return ClipHandler::handleCommand(args); };
